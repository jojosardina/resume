  ...
  \cventry
    ...
    {September 2019 - PRESENT} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Investigating how the complex symbiosis of the fungus-farming ants have driven their phenotypic diversity. See more at jojosardina.org/research.html}
      \end{cvitems}
    }

  \cventry
    {Lab Manager} % Job title
    {Kalan Lab, University of Wisconsin-Madison} % Organization
    {Madison WI} % Location
